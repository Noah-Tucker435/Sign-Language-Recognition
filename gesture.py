...
while True:
    ...
    if num_frames < 60:
        cal_avg(gray_frame, accumulated_weight)
        if num_frames <= 59:
            
            cv2.putText(frame_copy, "PLEASE WAIT", (75, 350), cv2.FONT_HERSHEY_SIMPLEX, 0.9, (0,0,255), 2)
  ...
  #segment hand
        ...
        if hand is not None:
            ...
            cv2.putText(frame_copy, 'No hand Present', (200, 400), cv2.FONT_HERSHEY_SIMPLEX, 1, (0,0,255), 2)
